...
int main()
{
    ...
    for (int iD=0; iD<nD; iD++)
    {
        for (int ik=0; ik<nk; ik++)
        {
            ...
            float angularDiffusion = pow(10, 0.0 - float(iD)*0.1); // Coeficiente de difusion angular
            ...
            float kineticRate    = pow(10, float(ik)*0.3 - 5.0);
            ...
            std::string iSimState = std::string("iSim_") 
                                  ...
                                  + "_"
                                  + (ik < 10 ? "00" : (ik < 100 ? "0" : "")) + std::to_string(ik)
                                  + ".txt";                                                            
